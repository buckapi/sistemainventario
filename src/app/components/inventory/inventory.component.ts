...
import { RealtimeCategoriesService } from '../../services/realtime-categories.service';
...
export class InventoryComponent {
  ...
  constructor(
    ...
    this.pb = new PocketBase('https://db.buckapi.lat:8095'); // Inicializa PocketBase
  ...
  openNewCategoryModal() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        ...
        this.realtimeCategories.categories$ = this.realtimeCategories.categories$;
      }
    });
  }
